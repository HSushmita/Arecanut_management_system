...
<div class="modal fade" id="catdetails" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      ...
      <form action="code.php" method="POST">
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                ...
                <input type="text" name="catid" class="form-control" placeholder="Enter category">
            </div>
            <div class="form-group">
                <label>name</label>
        ...
        <div class="modal-footer">
            ...
            <button type="submit" name="cattbtn" class="btn btn-primary">Save</button>
        </div>
      </form>
...
<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#catdetails">
       Add product details
</button>
      </h6>
    </div>      
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <button type="submit" name="catdelete_btn" class="btn btn-danger">DELETE</button>
                    </form>
                </td>
            </tr>
            <?php
